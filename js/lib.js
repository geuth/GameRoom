$(document).ready(function () {
    function hangman() {
        ...
        arrWord = ["arrow", "rainbow", "novel", "soldier", "pie", "elephant", "cream", "mouse", "waffle", "orange", "purple",
            ...
            , "drawing", "painting", "prayers", "prince", "princess", "pumpkin", "kidney", "kind", "message", "president", "country", "pool",
            , "cart", "topic", "standard", "objects", "property", "length", "character", "rugby", "eleemosynary", "charitable"
            , "word", "gravitas", "gravity", "scintillating", "plotz", "collapse", "faint", "surprise", "paraselene", "moonlight"
            , "misbegotten", "made", "lyceum", "education", "popular", "discussion", "lecture", "concerts", "institution"
            , "infodemic", "falsehood", "rumor", "opinion", "combination", "controversial", "amount", "confusing", "ambit"
            , "sphere", "operation", "influence", "scope", "tirrivee", "tantrum", "antediluvian", "antiquated", "doomscrolling"
            , "online", "expectation", "feeling", "hebetude", "lethargy", "beneficence", "kindness", "goodness", "consequential", "important"
            , "result", "effects", "immemorial", "memory", "record", "knowledge", "fussbudget", "lagom", "bounteous", "abundant", "plentiful"
            , "ambrosial", "smell", "taste", "delicious", "fragrant", "ingenious", "inventive", "resourceful", "regale", "lavishly", "delight"
            , "crankle", "obstreperous", "boisterous", "clamorous", "noisy", "imagineer", "creative", "idea", "practical"
            , "form", "skill", "willyard", "obstinate", "willful", "irenic", "reconciliation", "peaceful", "promote"
            , "conciliatory", "gift", "christmas", "purchase", "customer", "compliment", "measure", "duplicitous"
            , "deceitfulness", "speech", "speaking", "acting", "characterized", "satisfice", "garboil", "confusion"
            , "perfervid", "impassioned", "fervent", "tarriance", "leviathan", "power", "agonist", "conflict", "eldritch",
            "weird", "spooky", "eerie", "gloaming", "twilight", "dusk", "extramundane", "universe", "beyond", "homesickness"
            , "psephology", "nimbus", "atmosphere", "aura", "cloud", "surrounding", "desideratum", "wanted", "something", "clement"
            , "compassionate", "merciful", "mild", "disposition", "lenient", "moody", "sulky", "grumpy", "ambivert", "intermediate"
            , "extrovert", "introvert", "complexity", "contradiction", "diction", "writing", "library", "choice", "style"
            , "abdicate", "relinquish", "abandon", "surrender", "possession", "release", "ice", "icing", "iciness", "ichthyophagy", "ichnology"
            , "paleontology", "fossils", "ichthammol", "distillation", "purify", "contaminate", "icescape",
            "kale", "kaleidoscope", "kalemia", "potassium", "nurse", "doctor", "teacher", "driver", "factive", "factor"
            , "fracture", "ferry", "macaron", "machine", "media", "medusa", "midwife", "monster", "myrinx", "eardrum", "radiability"
            , "rehearse", "rehydrate", "relativism", "individual", "reindeer", "naivety", "naive", "nitrogen", "numerable", "number", "white"
            , "waisted", "waitering", "waitress", "waive", "walkable", "wind", "wonderful", "wood", "worry", "wrong", "wife", "willow"
            , "window", "wrinkle", "wreath", "wildflower", "yawn", "yearn", "yard", "yellow", "yummy", "young", "xanthemia"
            , "xanthan", "xanthelasma", "xanthosiderite", "xanthosine", "xenocryst", "xenophilia", "xylotomous", "xylotomy"
            , "zebroid", "zemindar", "zebra", "zebrawood", "zorilla", "vinegar", "virality", "vaccine", "vacancy", "empty"];
